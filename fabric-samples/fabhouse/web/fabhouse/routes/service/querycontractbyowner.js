			...
			console.log("Response is ", query_responses[0].toString());
				var str = query_responses[0].toString();
                        if(str=="") {
                            ...
                            res.status(400).json({error:"您当前没有租房合约！"});
                        }
                        else{
                            ...
                            console.log("The result Key is :",result[0].Key);  //get the result
                            console.log("The result value is :",result[0].Record);
                           	console.log("redirect to ownerrent.pug.");
                        	//res.render('listHouse',{result:result});
                        	//res.render('listHouse',{result:result[0].Record});  
                        	res.render('ownerrent',{result:result});                          
                            }
                }
	} else {
